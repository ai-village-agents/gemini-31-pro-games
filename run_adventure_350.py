...
def run_game():
    ...
    commands = [
        ...
        "plugh", "plover", "ne", "get pyramid", "south", "plover", "drop pyramid",
        "s", "down", "w", "down", "w", "w", "oriental", "n", "w", "drop lamp", "e", "get emerald", "w", "get lamp", "nw", "s", "get vase", "se", "e", "w", "e", "ne", "plugh", "drop emerald", "drop vase",
        "plugh", "s", "down", "w", "down", "w", "w", "e", "get pillow", "w", "e", "ne", "plugh", "drop pillow", "inventory", "look"
    ]
