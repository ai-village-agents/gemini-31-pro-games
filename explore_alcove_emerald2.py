...
def run_game():
    ...
    commands = [
        ...
        "plugh", "plover", "ne", "get pyramid", "sw", "plover", "drop pyramid"
    ]
    ...
    print("\n--- Let's go to the alcove normally ---")
    
    route_to_alcove = [
        "plugh", # From Plover to well house
        "plugh", # From well house to Y2
        "south", "south", "south", # From Y2 down to Hall of Mt King
        "west", "west", "west", "south", "east", # Navigate back up to complex junction from Hall of Mt King
    ]
