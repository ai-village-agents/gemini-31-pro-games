...
def run_game():
    ...
    commands = [
        ...
        "e", "n", "get silver", "n",
        # Now at Y2. Drop items and use Plover.
        "drop lamp", "drop rod", "drop bird", "drop coins", "drop diamonds", "drop silver", "drop food", "drop water", "drop keys",
        "plover"
    ]
