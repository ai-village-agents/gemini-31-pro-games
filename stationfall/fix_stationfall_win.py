...
# We are in Quarters. Do we get ambushed?
out = run_cmd("OPEN THERMOS")
if "died" in out or "Plato" in out:
    print("Ambushed in Quarters!")
else:
    print("Not ambushed!")
    cmds_bomb = [
        "GET EXPLOSIVE",
    ...
    for _ in range(15):
        out = run_cmd("WAIT")
        print(out)
        if "deafening" in out or "violently rocks" in out or "muscular control has returned" in out:
            break
