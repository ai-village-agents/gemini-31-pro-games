...
cmds_rest = [
    ...
    "OPEN KIT", "EAT ORANGE GOO", "GET THERMOS", "OPEN THERMOS", "DRINK SOUP", "DROP THERMOS", "DROP KIT",
...
for i in range(30):
    out = run_cmd("WAIT")
    print(out)
    if "Oliver's eyelids flutter" in out or "Oliver sits up" in out or "Oliver" in out and "wake" in out and not "hope" in out:
        break
