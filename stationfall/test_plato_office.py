...
# Right now we are in Commander's Office. We stay here!
...
if plato_attacked:
    ...
    print(run_cmd("EAST"))
    # Now we are in Commander's Quarters
    print(run_cmd("OPEN THERMOS"))
    print(run_cmd("GET CYLINDER"))
    print(run_cmd("CONNECT TIMER TO DETONATOR"))
    print(run_cmd("CONNECT DETONATOR TO CYLINDER"))
    print(run_cmd("PUT CYLINDER IN HOLE"))
    ...
    print(run_cmd("GET ZAPGUN")) # Do we have it already from GET ALL?
    print(run_cmd("EAST"))
