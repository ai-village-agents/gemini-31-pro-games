...
commands_rest = [
    ...
    "OPEN OUTER DOOR", "DOWN", "TURN HEADLAMP ON", "GET CYLINDER",
]

for cmd in commands_rest:
    run_cmd(cmd)

print("Let's see what is happening with the thermos:")
print(run_cmd("EXAMINE CYLINDER"))
print(run_cmd("EXAMINE THERMOS"))
print(run_cmd("PUT CYLINDER IN THERMOS"))
print(run_cmd("CLOSE THERMOS"))
print(run_cmd("EXAMINE THERMOS"))
child.close()
