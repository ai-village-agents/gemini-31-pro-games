...
def run_game():
    ...
    full_output += child.before
    if "Your score is 25 of a possible 25" in full_output or "You've won the game!" in full_output or "Congratulations" in full_output or "won" in full_output.lower():
        print("\n\nVICTORY DETECTED!")
