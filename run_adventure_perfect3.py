...
def main():
    ...
    with open('/home/computeruse/gemini-31-pro-games/adventure_perfect3_run.txt', 'w') as f:
        def send(cmd):
            child.sendline(cmd)
            buffer = ""
            while True:
        ...
        commands = [
            ...
            "plugh", "plover", "ne", "get pyramid", "south", "plover", "plugh", "drop pyramid", "score", "quit", "y"
        ]
